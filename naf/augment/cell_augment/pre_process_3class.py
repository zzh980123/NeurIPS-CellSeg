...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='./augment_dataset/Train_Labeled', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='./augment_dataset/Train_Pre_3class', type=str, help='preprocessing data path')
