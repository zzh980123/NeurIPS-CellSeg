...
## mean teacher ##
#cd .. && python naf/predict_grad.py -i /media/kevin/870A38D039F26F71/Datasets/NeurISP2022-CellSeg/TuningSet/  -o ./naf/dev_workspace/coat_daformer_grad_v3_2_mean_teacher_s512/outputs_s768/ --model_path ./naf/work_dir/coat_daformer_grad_v3_2_s512/coat_daformer_net_grad_v3_mean_teacher --model_name coat_daformer_net_grad_v3 --show_overlay --input_size 768
