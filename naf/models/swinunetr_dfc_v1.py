...
class DeformableConvLayer(nn.Module):
    ...
    def __init__(self, shape, in_channel, out_channel, kernel_size, stride, spatial_dims=2, max_view=9):
        super().__init__()
...
class UnetBasicBlockDFC(nn.Module):
    ...
    def __init__(
        ...
        # )
        self.conv2 = DeformableConvLayer(
            shape, in_channels, out_channels, kernel_size, 1, spatial_dims, max_view=9
        )
