...
# we apply huge convolution with size (31 x 31 = 5 x 31 + 31 x 5 + 5 x 5 re-parameter trick)
...
class DaFormaerCoATNet_GRAD_V3p1(nn.Module):
    ...
    def __init__(self,
                 ...
                 decoder=daformer_involution_hc,
                 decoder_dim=320):
        super(DaFormaerCoATNet_GRAD_V3p1, self).__init__()
        ...
        self.logit = nn.Sequential(
            ...
            # HugeConv2dBlock(decoder_dim, decoder_dim),
            nn.BatchNorm2d(decoder_dim),
            PixelShuffleBlock(decoder_dim, out_channel - 2, upscale_factor=4),
            nn.BatchNorm2d(out_channel - 2),
            # HugeConv2dBlock(out_channel - 2, out_channel - 2)
        )
